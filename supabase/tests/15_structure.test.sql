...
select throws_ok(
  $$select private.is_friend('11111111-1111-1111-1111-111111111111')$$, '42501',
  'while calling that same helper by name is refused at the schema');
select throws_ok(
  $$select private.neighbourhood('11111111-1111-1111-1111-111111111111')$$, '42501',
  'and so is the loader, which is behind both locks');
select throws_ok(
  $$select private.load_nodes(array['11111111-1111-1111-1111-111111111111']::uuid[])$$, '42501',
