...
select throws_ok(
  $$update public.profiles set friend_ids = array['22222222-2222-2222-2222-222222222222']::uuid[]
    where id = (select auth.uid())$$, '42703',
...
select throws_ok(
  ...
  '42501', 'an edge between two other people cannot be asserted');
...
select throws_ok(
  ...
  '42501', 'a stranger cannot write themselves into somebody''s adjacency');
select lives_ok(
