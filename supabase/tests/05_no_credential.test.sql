...
select throws_ok(
  $$select public.claim_username('nobody_h')$$, '42501', null,
  'cannot claim a handle');

set local request.jwt.claims = '{"sub":"33333333-3333-3333-3333-333333333333","role":"authenticated"}';
select throws_ok(
  $$select public.claim_username('anon_h')$$, '42501', null,
...
set local request.jwt.claims = '{"sub":"22222222-2222-2222-2222-222222222222","role":"authenticated"}';
select throws_ok(
  $$update public.profiles set username = 'owner_h' where id = (select auth.uid())$$, '42501', null,
